...
// alert("This is only use of ALEART")
...
// var courses = "Certified Web and Mobile App Dvelopment Course";
...
// var email = "My email address is abc@xyz.com"
...
// book = "I am tryping to learn from the Book A smarterway to learn Javascript";
...
// document.write( "My Brith Year is " + birthYear + "<br />" + "Data type of my ddeclared varible is number")

// Q-4

// var visitor = "Ameen";
// var title = "Jeans Pant";
// var quantity = "6";

// alert(visitor+" " +"ordered"+" "+quantity+" "+title +" on XYZ Clothing store")
...
// document.write("Your are either "+ (currentyear-birthyear1) + " " +"or " + (currentyear-birthyear2) + " " + "years old");
...
// document.write("You will need " + " " + restAge*perDay + " " + "to last you until the ripe old age of " +" " + maxAge )
...
// Q-4.Not Avialable in question pdf.
...
// var color=prompt("Enter only one signal color name");
// if(color === "red"){
//     alert("Must Stop");
...
// var a = prompt("Enter An/A Alphabates");

// if ( a >="A"  && a <= "Z") {
//     alert(a + " is Uppercase");
// } else if (a >= "a" && a <= "z") {
//     alert(a + " is Lowercase");
// }else {
//     alert(a + " is not a Alphabates");
// }
